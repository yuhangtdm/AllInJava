...
public class JobUtil {
    ...
    public String addJob(AppQuartz appQuartz) throws Exception {
        ...
        JobDetail jobDetail = JobBuilder.newJob(JobOne.class)
                .withIdentity(appQuartz.getJobName(), appQuartz.getJobGroup()).build();
...
//                .withSchedule(scheduleBuilder).build();
        ...
        CalendarIntervalTrigger trigger = TriggerBuilder.newTrigger().withIdentity(appQuartz.getJobName(), appQuartz.getJobGroup()).startAt(date)
                .withSchedule(calendarIntervalScheduleBuilder).build();
